...
<html lang="en">
  ...
  <body>
    <div class="container">
      ...
      <a href="kelola.php" type="button" class="btn btn-primary mb-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" 
      ...
      <table id="example" class="table table-hover table-bordered align-middle">
        ...
        <tbody class="table-group-divider">
          ...
          <tr>
            ...
            <td><img src="gambar/<?php echo $data['gambar']?>" alt="gambar" style="width: 40px"/></td>
            <td>
            <a href="kelola.php?edit=<?php echo $data['id']; ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
